...
(function () {
  ...
  `;
    ...
    style.textContent = `
        ...
        .token-button:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(0,0,0,0.3); }
        ...
        .stat-icon { font-size: 20px; color: #9b59b6; margin-bottom: 4px; }
